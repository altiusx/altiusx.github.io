    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-hideout-bg text-slate-900 dark:text-hideout-text p-4 md:p-8 font-sans selection:bg-hideout-accent selection:text-white">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-[180px] ">
          {/* 1. HERO BLOCK */}
          <Card className="lg:col-span-2 lg:row-span-2 flex flex-col justify-between group bg-gradient-to-b dark:from-hideout-card ">
            <div className="z-10">
          ...
          <Card className="lg:col-span-1 lg:row-span-2 flex flex-col justify-between bg-gradient-to-b from-white to-zinc-50 dark:from-hideout-card dark:to-[#162032]">
            ...
            <button
              ...
              className="absolute bottom-5 right-5 w-12 h-12 rounded-full bg-orange-100 dark:bg-hideout-accent/20 flex items-center justify-center mb-4 transition-all hover:scale-110 hover:bg-orange-200 dark:hover:bg-hideout-accent/30 cursor-pointer"
          ...
          <Card className="lg:col-span-1 flex flex-col justify-between">
            <MapPin className="text-hideout-accent" />
            <div>
              <h3 className="text-lg font-bold text-slate-900 dark:text-white">Singapore</h3>
              <p className={monoLabel}>based in Singapore</p>
            </div>
          </Card>
          ...
          <Card className="lg:col-span-1 flex flex-col justify-center">
            <div className="flex items-center gap-2 mb-1">
              <LaptopMinimal size={16} className="text-hideout-accent" />
              <span className={monoLabelCaps}>Tech_Arsenal</span>
            </div>
            <div className="flex flex-wrap gap-2">
              {['React', 'Angular', 'Python', 'TypeScript', 'Node.js', 'MongoDB', 'SQL'].map(
                (tech) => (
                  <span
                    key={tech}
